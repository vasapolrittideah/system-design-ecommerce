// Command server runs the catalog gRPC server.
package main
...
import (
	...
	"github.com/vasapolrittideah/system-design-ecommerce/services/catalog/internal/bootstrap"
)
...
func run() error {
	...
	catalogv1.RegisterCatalogServiceServer(srv.Registrar(), bootstrap.NewCatalogHandler(pool))
	...
	log.Info("catalog stopped cleanly")
